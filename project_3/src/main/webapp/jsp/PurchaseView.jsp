								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="totalQuantity"
											placeholder="Total Quantity"  maxlength="10"
											oninput="handleIntegerInput(this, 'totalQuantityError', 9)"
											onblur="validateIntegerInput(this, 'totalQuantityError', 9)"
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="totalCost"
											placeholder="Total Cost" maxlength="10"
											oninput="handleIntegerInput(this, 'totalCostError', 9)"
											onblur="validateIntegerInput(this, 'totalCostError', 9)"
